...
builder.Services.AddAuthorization(options => {
    options.AddPolicy("SEonly", policy => policy.RequireClaim("department", "SE"));
    options.AddPolicy("CSonly", policy => policy.RequireClaim("department", "CS"));
